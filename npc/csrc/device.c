...
const mmio_map soc_device_map[SOC_DEVICE_NUM] = {
  {"clint", 0x02000000, 0x10000},//0x0200_0000~0x0200_ffff
  {"sram",0x0f000000,0x00002000},//0x0f00_0000~0x0fff_ffff in fact but we only use 8KB for now:0x0f00_0000~0x0f00_1fff
  {"uart", 0x10000000, 0x1000},//0x1000_0000~0x1000_0fff
  {"spi", 0x10001000, 0x1000},//0x1000_1000~0x1000_1fff
  {"gpio",0x10002000,0x10},//0x1000_2000~0x1000_200f
  {"ps2",0x10011000,0x8},//0x1001_1000~0x1001_1007
  {"mrom", 0x20000000, 0x1000},//0x2000_0000~0x2000_0fff
  {"vga",0x21000000,0x200000},//0x2100_0000~0x211f_ffff
  {"flash", 0x30000000, 0x10000000},//0x3000_0000~0x3fff_ffff
  {"chiplinkMMIO",0x40000000,0x40000000},//0x4000_0000~0x7fff_ffff
  {"pSRAM",0x80000000,0x20000000},//0x8000_0000~0x9fff_ffff in fact it has only 4MB space:0x8000_0000~0x803f_ffff len:0x400000
  {"sdram",0xa0000000,0x20000000},//0xa000_0000~0xbfff_ffff in fact it has only 32MB space:0xa000_0000~0xa1ff_ffff len:0x2000000
  {"chiplinkMEM",0xc0000000,0x40000000}//0xc000_0000~0xffff_ffff
