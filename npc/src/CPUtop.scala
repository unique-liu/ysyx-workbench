...
class ysyx_26050152 extends Module{
    ...
    val u_cpu                           = withModulePrefix("ysyx_26050152"){ Module(new CPUtop) }
    io <> u_cpu.io
}
...
class CPUtop extends Module{
    ...
    // io.slave_awid                       := Input (UInt(4.W))
    // io.slave_awlen                      := Input (UInt(8.W))
